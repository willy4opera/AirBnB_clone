 #!/usr/bin/python3
"""Here, we defined unittests for console.py.
...
class TestHBNBCommand_prompting(unittest.TestCase):
    ...
    def test_prompt_string(self):
        self.assertEqual("(devHBNB) ", HBNBCommand.prompt)

    def test_dev_empty_line(self):
...
class TestHBNBCommand_help(unittest.TestCase):
    ...
    def test_dev_help_quit(self):
        rst = "Quit command to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help quit"))
            self.assertEqual(rst, output.getvalue().strip())

    def test_dev_help_create(self):
        rst = ("Usage: create <class>\n        "
             "Create a new class instance and print its id.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help create"))
            self.assertEqual(rst, output.getvalue().strip())

    def test_dev_help_EOF(self):
        rst = "EOF signal to exit the program."
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(rst, output.getvalue().strip())

    def test_dev_help_show(self):
        rst = ("Usage: show <class> <id> or <class>.show(<id>)\n        "
    ...
    def test_dev_help_destroy(self):
        rst = ("Usage: destroy <class> <id> or <class>.destroy(<id>)\n        "
             "Delete a class instance of a given id.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help destroy"))
            self.assertEqual(rst, output.getvalue().strip())

    def test_dev_help_all(self):
        rst = ("Usage: all or all <class> or <class>.all()\n        "
    ...
    def test_dev_help_count(self):
        rst = ("Usage: count <class> or <class>.count()\n        "
             "Retrieve the number of instances of a given class.")
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help count"))
            self.assertEqual(rst, output.getvalue().strip())

    def test_Dev_help_update(self):
        rst = ("Usage: update <class> <id> <attribute_name> <attribute_value> or"
    ...
    def test_dev_help(self):
        rst = ("Documented commands (type help <topic>):\n"
             "========================================\n"
...
class TestHBNBCommand_exit(unittest.TestCase):
    ...
    def test_dev_quit_exits(self):
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertTrue(HBNBCommand().onecmd("quit"))

    def test_dev_EOF_exits(self):
        with patch("sys.stdout", new=StringIO()) as output:
